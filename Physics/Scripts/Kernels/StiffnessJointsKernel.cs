...
// Type: GPUTools.Physics.Scripts.Kernels.StiffnessJointsKernel
...
namespace GPUTools.Physics.Scripts.Kernels
{
  ...
  {
    public StiffnessJointsKernel(
      GroupedData<GPDistanceJoint> groupedData,
      GpuBuffer<GPDistanceJoint> stiffnessJointsBuffer)
    ...
    public GpuBuffer<GPDistanceJoint> StiffnessJointsBuffer { set; get; }

    private GroupedData<GPDistanceJoint> StiffnessJoints { set; get; }
    ...
    public override void Dispatch()
    {
      ...
      this.BindAttributes();
      for (int index = 0; index < this.StiffnessJoints.GroupsData.Count; ++index)
      {
        GroupData groupData = this.StiffnessJoints.GroupsData[index];
