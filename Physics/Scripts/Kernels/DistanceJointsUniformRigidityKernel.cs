...
// Type: GPUTools.Physics.Scripts.Kernels.DistanceJointsUniformRigidityKernel
...
namespace GPUTools.Physics.Scripts.Kernels
{
  ...
  {
    public DistanceJointsUniformRigidityKernel(
    ...
    [GpuData("rigidity")]
    public GpuValue<float> Rigidity { set; get; }
    ...
    private GroupedData<GPDistanceJoint> DistanceJoints { set; get; }
