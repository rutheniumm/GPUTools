...
// Type: GPUTools.Physics.Scripts.Behaviours.CapsuleLineSphereCollider
...
namespace GPUTools.Physics.Scripts.Behaviours
{
  ...
  public class CapsuleLineSphereCollider : LineSphereCollider
  {
    ...
    {
      float num1 = radius + this.oversizeRadius;
      float num2 = (float) (((double) height + (double) this.oversizeHeight) * 0.5);
