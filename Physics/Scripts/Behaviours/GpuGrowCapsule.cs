...
// Type: GPUTools.Physics.Scripts.Behaviours.GpuGrowCapsule
  ...
  public class GpuGrowCapsule : GpuEditCapsule
  {
    private void OnEnable()
    {
      ...
      if (Application.isPlaying)
        GPUCollidersManager.RegisterGrowCapsule((GpuEditCapsule) this);
      this.UpdateData();
    }
    ...
    private void OnDisable()
    {
      if (!Application.isPlaying)
        return;
      GPUCollidersManager.DeregisterGrowCapsule((GpuEditCapsule) this);
    }
  }
}
