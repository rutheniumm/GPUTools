...
// Type: GPUTools.Physics.Scripts.Behaviours.GpuCutCapsule
  ...
  public class GpuCutCapsule : GpuEditCapsule
  {
    private void OnEnable()
    {
      ...
      if (Application.isPlaying)
        GPUCollidersManager.RegisterCutCapsule((GpuEditCapsule) this);
      this.UpdateData();
    }
    ...
    private void OnDisable()
    {
      if (!Application.isPlaying)
        return;
      GPUCollidersManager.DeregisterCutCapsule((GpuEditCapsule) this);
    }
  }
}
