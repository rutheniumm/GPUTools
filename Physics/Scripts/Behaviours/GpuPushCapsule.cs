...
// Type: GPUTools.Physics.Scripts.Behaviours.GpuPushCapsule
  ...
  public class GpuPushCapsule : GpuEditCapsule
  {
    private void OnEnable()
    {
      ...
      if (Application.isPlaying)
        GPUCollidersManager.RegisterPushCapsule((GpuEditCapsule) this);
      this.UpdateData();
    }
    ...
    private void OnDisable()
    {
      if (!Application.isPlaying)
        return;
      GPUCollidersManager.DeregisterPushCapsule((GpuEditCapsule) this);
    }
  }
}
