...
// Type: GPUTools.Physics.Scripts.Behaviours.GpuPullCapsule
  ...
  public class GpuPullCapsule : GpuEditCapsule
  {
    private void OnEnable()
    {
      ...
      if (Application.isPlaying)
        GPUCollidersManager.RegisterPullCapsule((GpuEditCapsule) this);
      this.UpdateData();
    }
    ...
    private void OnDisable()
    {
      if (!Application.isPlaying)
        return;
      GPUCollidersManager.DeregisterPullCapsule((GpuEditCapsule) this);
    }
  }
}
